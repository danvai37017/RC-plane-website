...
export default {
  topic: 'electronics',
  slug: 'motors-and-kv-ratings',
  category: 'Electronics',
  tags: ['Motors'],
  title: 'Motors and KV Ratings',
  excerpt:
  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        { type: 'p', text: '[Placeholder — to be written] Kv rating is one of the most misunderstood specifications in RC electronics. Kv stands for "RPM per volt". A motor rated at 1000 Kv will spin at 1000 RPM for every volt applied, assuming no load. Under load, the actual RPM will be lower.' },
    ...
    {
      id: 'picking-the-right-kv',
      level: 2,
      title: 'Picking the Right Kv Rating',
      content: [
        { type: 'p', text: '[Placeholder — to be written] Lower Kv motors spin larger props at lower speeds; higher Kv motors spin smaller props at higher speeds. Choose your Kv based on the prop size and battery voltage you plan to use.' },
      ],
    },
  ],
}